...
static fib_node0_t *const fib_level0 = (fib_node0_t *)FIB_BASE;
static fib_node_t *const fib_levels[FIB_NUM_LEVELS] = {
    (fib_node_t *)(FIB_BASE + 1 * 0x8000), (fib_node_t *)(FIB_BASE + 2 * 0x8000),
    (fib_node_t *)(FIB_BASE + 3 * 0x8000), (fib_node_t *)(FIB_BASE + 4 * 0x8000),
    (fib_node_t *)(FIB_BASE + 5 * 0x8000), (fib_node_t *)(FIB_BASE + 6 * 0x8000),
    (fib_node_t *)(FIB_BASE + 7 * 0x8000), (fib_node_t *)(FIB_BASE + 8 * 0x8000),
    (fib_node_t *)(FIB_BASE + 9 * 0x8000), (fib_node_t *)(FIB_BASE + 10 * 0x8000),
    (fib_node_t *)(FIB_BASE + 11 * 0x8000), (fib_node_t *)(FIB_BASE + 12 * 0x8000),
    (fib_node_t *)(FIB_BASE + 13 * 0x8000), (fib_node_t *)(FIB_BASE + 14 * 0x8000),
    (fib_node_t *)(FIB_BASE + 15 * 0x8000), (fib_node_t *)(FIB_BASE + 16 * 0x8000),
    (fib_node_t *)(FIB_BASE + 17 * 0x8000), (fib_node_t *)(FIB_BASE + 18 * 0x8000),
    (fib_node_t *)(FIB_BASE + 19 * 0x8000), (fib_node_t *)(FIB_BASE + 20 * 0x8000),
    (fib_node_t *)(FIB_BASE + 21 * 0x8000), (fib_node_t *)(FIB_BASE + 22 * 0x8000),
    (fib_node_t *)(FIB_BASE + 23 * 0x8000), (fib_node_t *)(FIB_BASE + 24 * 0x8000),
    (fib_node_t *)(FIB_BASE + 25 * 0x8000), (fib_node_t *)(FIB_BASE + 26 * 0x8000),
    (fib_node_t *)(FIB_BASE + 27 * 0x8000), (fib_node_t *)(FIB_BASE + 28 * 0x8000),
    (fib_node_t *)(FIB_BASE + 29 * 0x8000)
};
nexthop_info_t *const fib_nexthop = (nexthop_info_t *)(FIB_BASE + 30 * 0x8000);
...
void init_fib()
{
    ...
    for (int i = 0; i < FIB_NUM_LEVELS * 4096; ++i) ptr[i] = -1;
...
{
    uint16_t nexthop_id = ETH_DEFAULT_NEXTHOP_ID;
...
void fib_print()
{
    ...
    (
        ...
        "mv sp, %1\n\t"
        : "=m"(_saved_sp)
        : "r"(_big_stack + sizeof(_big_stack) + STACK_OFFSET)
    );
    printf("Default Route Nexthop: 0x%04x\r\n", ETH_DEFAULT_NEXTHOP_ID);
