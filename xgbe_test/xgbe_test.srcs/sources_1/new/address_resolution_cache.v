...
/* WARNING: copied from address_mapping_cache */

module address_resolution_cache(
    input eth_coreclk,
    input reset,

    input [15:0] atime_counter,

    input [127:0] s0_addrs,
    output wire [47:0] s3_new_addrs,
    output wire [0:0] s3_new_addr_valids,
    output wire [15:0] s3_new_addr_atimes,
    ...
    blk_mem_gen_for_arc blk_mem_gen_for_arc_0(
        .clka(eth_coreclk),
        .wea(bram_wea[0]),
        .addra(bram_addra[0]),
        .dina(bram_dina[0]),
    ...
    generate
        ...
        begin
            blk_mem_gen_for_arc blk_mem_gen_for_arc_i(
                .clka(eth_coreclk),
                .wea(bram_wea[j]),
                .addra(bram_addra[j]),
                .dina(bram_dina[j]),
